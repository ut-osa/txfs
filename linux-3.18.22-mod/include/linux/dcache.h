...
struct dentry {
	...
	/* Used by fs tx */
	struct dentry_rec *d_dentry_rec;
	unsigned long long d_ctime;		/* dentry change time */
	pid_t d_commit_pid; /* thread pid keeps the d_lock */
};
...
/* for fs transactions */
#define DCACHE_IN_COMMIT		0x01000000
#define DCACHE_IN_MEM			0x02000000
...
/* exposed for being used by txfs */
extern inline void __dget_dlock(struct dentry *dentry);
extern inline void __dget(struct dentry *dentry);
...
/* dcache_memlog.c */
extern struct dentry *d_splice_alias_memlog(struct inode *inode, struct dentry *dentry);
extern inline void dentry_start_write(struct dentry *dentry);
 ...
 */
extern void _d_rehash(struct dentry * entry);
